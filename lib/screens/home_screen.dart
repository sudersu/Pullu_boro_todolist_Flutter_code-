...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _handleSaveTask(Map<String, dynamic> taskData) async {
    ...
    if (taskData['reminder'] == true && _settings.notificationsEnabled) {
    ...
    // Save to storage and reschedule notifications
  ...
  Future<void> _handleToggleComplete(String taskId) async {
    ...
    if (updatedTask.completed) {
      await NotificationService.cancelNotification(taskId);
    } else if (updatedTask.reminder && _settings.notificationsEnabled) {
